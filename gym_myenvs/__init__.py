...
register(
    id='procon18env-v8003',
    entry_point='gym.envs.myenv:procon18Env_8003',
)
register(
    id='procon18env-v8004',
    entry_point='gym.envs.myenv:procon18Env_8004',
)
register(
    id='procon18env-v8005',
    entry_point='gym.envs.myenv:procon18Env_8005',
)

#myenv2
# ----------------------------------------
register(
    id='procon18env_re-v0',
    entry_point='gym.envs.myenv2:procon18Env_re',
)
# ----------------------------------------
# Algorithmic
# ----------------------------------------
